...
function Highlights() {
  ...
  return (
    <div className="flex md:flex-row flex-col items-center justify-center p-2 pt-64 md:pl-28">
      <section className="flex flex-col justify-center space-y-6 relative md:left-72 lg:left-64 pt-72 md:-translate-x-1/2 z-50">
      ...
      <section className="">
        ...
        >
          ...
          />
          <div className="absolute w-16 h-16 rounded-full transition duration-500 top-1/2 left-1/2 flex items-center justify-center bg-purple z-50">
